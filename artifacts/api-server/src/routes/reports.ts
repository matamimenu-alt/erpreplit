...
router.get("/pl", async (req, res) => {
  try {
    ...
    // Only count MANUAL entries — auto-generated (purchase/payroll/fixed-cost mirrors) are already
    // counted via their own P&L sections above, so excluding them prevents double-counting.
