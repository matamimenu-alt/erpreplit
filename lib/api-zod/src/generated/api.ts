...
export const ListEmployeesResponseItem = zod.object({
  ...
  jobTitle: zod.string(),
  salary: zod.number(),
  iqamaExpiryDate: zod.string().optional(),
  iqamaRenewalDate: zod.string().optional(),
  lastTravelDate: zod.string().optional(),
  vacationBalance: zod.number(),
  accommodationCost: zod.number(),
  medicalInsurance: zod.number(),
  gosiInsurance: zod.number(),
